...
CC		= icc
DEFS		= -DHAVE_CONFIG_H
CFLAGS		= -g -O2 -fdebug-prefix-map=/home/richard/debs/vim/vim=. -fstack-protector-strong -Wformat -Werror=format-security -march=native -pipe -DTINY_VIMRC
CPPFLAGS	= -Wdate-time
srcdir		= .

LDFLAGS		= -Wl,-z,relro -Wl,-z,now,--gc-sections,--print-gc-sections,--print-memory-usage,--relax,--stats -Wl,--as-needed
LIBS		= -lm -ltinfo  -lselinux -lacl -lattr
TAGPRG		= ctags
