...
;
#line 1544 "if_perl.xs"
	char_u *value;
#line 1753 "if_perl.c"
#line 1546 "if_perl.xs"
...
XS_EUPXS(XS_VIM_Buffers)
{
    ...
    SP -= items;
    {
#line 1563 "if_perl.xs"
    buf_T *vimbuf;
    int i, b;

#line 1787 "if_perl.c"
#line 1567 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
	{
...
XS_EUPXS(XS_VIM_Windows)
{
    ...
    SP -= items;
    {
#line 1614 "if_perl.xs"
    win_T   *vimwin;
    int	    i, w;

#line 1851 "if_perl.c"
#line 1618 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
...
XS_EUPXS(XS_VIBUF_Number); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_VIBUF_Number)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "vimbuf");
...
#  endif
        ...
        (void)newXSproto_portable("VIBUF::Number", XS_VIBUF_Number, file, "$");
